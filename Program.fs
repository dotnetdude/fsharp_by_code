...
printfn "THe value of MyInt is %i" myInt
printfn "THe value of myFloat is %f" myFloat
printfn "THe value of myString is %s" myString
printfn "-----------------------"
...
printfn "THe value of twoToFive is %A" twoToFive
printfn "THe value of oneToFive is %A" oneToFive
printfn "THe value of zeroToFive is %A" zeroToFive
printfn "-----------------------"
...
printfn "The sum of square of 100 normal way %i" sumOfSquaresTo100
...
printfn "The sum of square of 100 using pipes %i" sumOfSquaresTo100piped

// you can define lambdas (anonymous functions) using the "fun" keyword
let sumOfSquaresTo100withFun =
   [1..100] |> List.map (fun x -> x * x) |> List.sum

printfn "The sum of square of 100 using lambdas %i" sumOfSquaresTo100withFun
printfn "-----------------------"
